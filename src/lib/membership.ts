...
interface MembershipRow {
  ...
  // Column name kept as monthly_price for historical reasons (see
  // db/schema.sql's comment) — it actually holds whichever billing_cycle's
  // price was chosen, not always a monthly figure.
