...
export function GroupPosts({ groupType, groupKey, groupLabel, profile }: GroupPostsProps) {
      ...
      <div className="flex-1 space-y-4 p-4">
        ...
        {posts.map((p) => (
          <button
            ...
            className="block w-full rounded-2xl bg-gray-50 p-4 text-left transition hover:bg-gray-100 dark:bg-gray-700/40 dark:hover:bg-gray-700/70"
          >
