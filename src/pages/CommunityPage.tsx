  ...
  return (
    <div className="pt-16 sm:pt-20">
      ...
      <section className="relative overflow-hidden bg-cyan-950 py-16 dark:bg-gray-900 sm:py-20">
        {/* Cyan in light mode, unchanged (orange-tinted near-black) in dark mode. */}
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-950 via-cyan-900/95 to-cyan-700/50 dark:from-gray-900 dark:via-gray-900/95 dark:to-orange-900/50" />
